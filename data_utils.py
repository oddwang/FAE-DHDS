...
def adversarial_samples(dataset):
    x_test = np.loadtxt('./datasets/' + dataset + '_X_adversarial.csv', delimiter=',').astype(float)
    y_test = np.loadtxt('./datasets/' + dataset + '_y_adversarial.csv', delimiter=',').astype(int)
