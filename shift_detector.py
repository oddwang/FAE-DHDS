...
class ShiftDetector:
    ...
    def __init__(self, dr_techniques, test_types, od_tests, md_tests, sign_level, red_models, sample, datset, model_name):
    ...
    def detect_data_shift(self, X_tr, y_tr, X_val, y_val, X_te, y_te, orig_dims, nb_classes):
        ...
        for dr_ind, dr_technique in enumerate(self.dr_techniques):
            ...
            shift_reductor = ShiftReductor(X_tr, y_tr, X_val, y_val, DimensionalityReduction(dr_technique), orig_dims, self.datset, self.model_name, dr_amount=32)
