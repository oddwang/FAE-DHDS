...
format = ['-o', '-h', '-p', '-s', '-D', '-<', '->', '-X', '-v', '-*']
markers = ['o', 'h', 'p', 's', 'D', '<', '>', 'X', 'v', '*']
colors_old = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728',
              '#9467bd', '#8c564b', '#e377c2', '#7f7f7f',
              '#bcbd22', '#17becf']
colors = ['#2196f3', '#f44336', '#9c27b0', '#64dd17', '#009688', '#ff9800', '#795548', '#607d8b', '#607d8b', '#E8F344']
...
if test_type == 'multiv':
    dr_techniques = [DimensionalityReduction.NoRed.value, DimensionalityReduction.PCA.value,
                     ...
                     DimensionalityReduction.Grad.value, DimensionalityReduction.GI.value]
if test_type == 'univ':
